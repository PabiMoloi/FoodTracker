...
class MealTableViewController: UITableViewController {
    ...
    private func setupNavigationBar() {
        ...
        let addButton = UIBarButtonItem(
            barButtonSystemItem: .add, target: self, action: #selector(MealTableViewController.addButtonTapped))
...
extension MealTableViewController {
    @IBAction func addButtonTapped() {
        ...
        guard let vc = container.resolve(MealView.self) as? MealViewController else {
            fatalError("Could not get MealViewController")
        }
...
extension MealTableViewController {
    ...
    override func tableView(
        _ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
